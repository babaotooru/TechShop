        ...
        <div className="w-full lg:w-64 bg-neutral-900 border-r border-neutral-700 p-5 space-y-6">
            ...
            <div>
                ...
                <ul className="space-y-2 text-gray-300">
                    <li className="cursor-pointer" onClick={() => setSort("latest")}>Latest</li>
                    <li className="cursor-pointer" onClick={() => setSort("lowToHigh")}>Price Low → High</li>
                    <li className="cursor-pointer" onClick={() => setSort("highToLow")}>Price High → Low</li>
                </ul>
            </div>
            ...
            <div>
                ...
                <p className="text-gray-400">Up to ₹{priceRange}</p>
                <input
                    type="range"
                    min="0"
                    max="20000"
...
const AllProductsPage = () => {
    ...
    const clearAll = () => {
        ...
        toast.info("Filters & Cart Cleared", {
            position: "top-right",
            autoClose: 2000,
